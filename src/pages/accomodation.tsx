...
function Accomodation() {
    return (
        <div className="flex flex-col justify-center items-center w-full lg:h-[700px] h-[1800px] md:h-[2150px] m-auto bg-yellow-400">
            ...
            <div className="lg:flex lg:flex-row  flex-col w-full flex-bg-blue-400 lg:h-1/2 lg:m-0 lg:flex-nowrap flex-wrap  ">
                <div className="lg:w-1/4 p-4 bg-blue-400 lg:mr-8  rounded-3xl lg:ml-10 mt-5 md:w-4/6 lg:m-0 m-auto">
                    <div className="h-4/5 bg-gray-200 rounded-3xl ">
                ...
                <div className="lg:w-1/4 p-4 bg-blue-400 lg:mr-8  lg:ml-8 rounded-3xl lg:m-0 mt-5 md:w-4/6 m-auto">
                    <div className="h-4/5 bg-gray-200 rounded-3xl">
                ...
                <div className="lg:w-1/4 p-4 bg-blue-400 lg:ml-8 rounded-3xl lg:mr-8 lg:m-0 mt-5 md:w-4/6 m-auto">
                    <div className="h-4/5 bg-gray-200 rounded-3xl">
