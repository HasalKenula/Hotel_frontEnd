...
function Facilities() {
    return (
        <div className="flex flex-col justify-center items-center w-full lg:h-[800px] h-[1600px] md:h-[1200px] m-auto  ">
            ...
            <div className="lg:flex lg:flex-row  flex-col w-full flex lg:h-1/3 lg:m-0 lg:flex-nowrap flex-wrap   ">
                <div className="lg:w-1/3 p-4  lg:mr-8  rounded-3xl lg:ml-10 mt-5 md:w-4/6 lg:m-0 m-auto">
                    ...
                    <div className="flex justify-center   m-auto lg:leading-8 lg:pt-8">
            ...
            <div className="lg:flex lg:flex-row  flex-col w-full flex lg:h-1/3 lg:mt-10 lg:flex-nowrap flex-wrap  ">
                <div className="lg:w-1/3 p-4 lg:mr-8  rounded-3xl lg:ml-10 mt-5 md:w-4/6 lg:m-0 m-auto">
                    <div className="rounded-3xl flex justify-center items-center mb-2">
                        <div className='mr-5 '>
